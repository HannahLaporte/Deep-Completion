...
from utils import compute_errors, eval_metrics, \
                       block_print, enable_print, normalize_result, inv_normalize, convert_arg_line_to_args, save_result
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            depth_est, loss, tempG, tempC, tempd16, d_u4, d_u3, d_u2, tempd, tempx, tempx16, tempx8 = model(image, depth_gt, sparse)
